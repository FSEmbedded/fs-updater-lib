...
namespace subprocess 
{
    ...
    class ErrorChildProcess : public SubprocessError
    {
        public:
            /**
             ...
             */
            ErrorChildProcess(const pid_t process_id, const std::string & msg)
            {
    ...
    class ErrorWaitForWait : public SubprocessError
    {
        public:
        /**
         ...
         */
        ErrorWaitForWait(const pid_t process_id, const int local_errno)
        {
    ...
    class ErrorOpenPipeParent : public SubprocessError
    {
        public:
            /**
             ...
             */
            explicit ErrorOpenPipeParent(const int local_errno)
            {
    ...
    class ErrorReadPipe : public SubprocessError
    {
        public:
             ...
             */
            explicit ErrorReadPipe( const int local_error)
            {
                this->error_string = std::string("Error during reading pipe; errno: ") + std::to_string(local_error);
            }
    };

    class ErrorCreatePipe : public SubprocessError
    {
        public:
            /**
             * Could not read from pipe.
             * @param local_error Errno variable during error occurs.
             */
            explicit ErrorCreatePipe( const int local_error)
            {
